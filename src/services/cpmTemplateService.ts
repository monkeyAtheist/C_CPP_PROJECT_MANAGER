 ...
 * - keeps the generated API small enough to copy into any CPM project.
 *
 * @par Typical applications
 ...
 *
 * @par Usage notes
 * - Use the CPM error macro when available so file, line and function are captured automatically.
